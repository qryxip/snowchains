...
use snowchains_core::web::{
    Codeforces, CodeforcesRetrieveLanguagesCredentials, CodeforcesRetrieveLanguagesTarget,
    CookieStorage, RetrieveLanguages, StandardStreamShell,
};
...
fn main() -> anyhow::Result<()> {
    ...
    let outcome = Codeforces::exec(RetrieveLanguages {
        target: CodeforcesRetrieveLanguagesTarget {
